module github.com/sausaging/go-relayer
...
require (
	...
	github.com/sausaging/hyper-pvzk v0.0.0-20240327041747-232514f0b90a
...
replace github.com/ava-labs/hypersdk => github.com/sausaging/hypersdk v0.0.1
